...
GroupPlayerService = {
	...
	findPlayerGroupById: function(id){
		...
		var queryFindPlayerGroup = DatabaseService.format('select players.*, groupPlayers.joinedAt, groupPlayers.role from players, groupPlayers where groupPlayers.playerId = players.id and groupPlayers.id = ? limit 1', [id]);
