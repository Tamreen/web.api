...
create table trainingActivities(
	...
	trainingId bigint(20) not null,
	authorId bigint(20) not null,
	type enum('training-started','player-decided-to-come','player-apologized','player-registered-as-subset','training-completed','training-not-completed','training-canceled', 'training-finished', 'player-brought-professional', 'training-allowed-professional', 'player-allowed-public', 'player-poked') not null,
	createdAt datetime not null,
	primary key(id)
);
